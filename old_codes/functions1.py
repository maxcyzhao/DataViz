...
def check_string_f(many_lines, department, df):
    ...
    for i in range(0, len(list_o_lines)):
        ...
        if line.startswith(department):
            ...
            row_n += 1
    generated_csv_filename = 'old_generated_csv/' + department + '.csv'
...
# data = pd.read_csv('old_course_txt_from_html/holder.txt', sep="\n", header=None)
# data = pd.read_csv('old_course_txt_from_html/ARBC.txt', sep="\n", header=None)
# print(data)

'''
data = pd.read_csv('old_course_txt_from_html/BIOL.txt', sep="\n", header=None)
...
data = pd.read_csv('old_course_txt_from_html/CSC.txt', sep="\n", header=None)
